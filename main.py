...
async def cmd_start(message: Message):
    ...
    await message.answer(
        ...
        f"/баланс — проверить свой урожай\n"
        f"/топ — рейтинг игроков\n"
        f"/ежедневно — ежедневный бонус (+50🍇)\n"
...
@dp.message(Command("ежедневно", "daily"))
async def cmd_daily(message: Message):
    ...
    await message.answer(
        f"🎁 **Ежедневный бонус!**\n\n"
        f"+{DAILY_BONUS} винограда 🍇\n"
        f"Заходи завтра за новым!"
    )
...
async def cmd_help(message: Message):
    await message.answer(
        ...
        "/ежедневно — бонус каждый день (+50🍇)\n"
        "/помощь — эта справка\n"
        "/статистика — статистика бота\n\n"
        "⏱ Кулдаун сбора: 60 секунд\n"
